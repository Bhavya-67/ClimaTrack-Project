...
with col2:
    st.markdown(
        '<div class="title-text">ClimaTrack - Climate Intelligence Platform</div>',
        ...
        if city:
            ...
            if lat is not None and lon is not None:
                ...
                if response.status_code == 200:
                    ...
                    st.error("Failed to connect to weather service.")
...
with tab2:
    ...
    st.info("Interactive global map coming soon.")
